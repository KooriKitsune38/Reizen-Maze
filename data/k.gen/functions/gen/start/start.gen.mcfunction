...
execute if entity @s[tag=k.gCenter3] as @e[type=marker,tag=k.gSide,distance=..10.5,sort=nearest,limit=1] at @s facing entity @e[type=marker,tag=k.temp] feet run function k.gen:gen/start/last.gen
...
execute if entity @s[tag=k.gCenter3] unless entity @e[type=marker,tag=k.gSide,distance=..10.5] run tag @s add k.gGenComplete
