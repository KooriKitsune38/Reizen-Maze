...
give @s llama_spawn_egg{Enchantments:[{}],display:{Name:'{"text": "Levitator (Book Shelf)","italic":false,"color": "gold"}',Lore:['{"text": "Spawns a levitating entity.","color": "aqua"}']},EntityTag:{id:"marker",Tags:["k.gEntity","k.gMarker","k.gLevitating","k.gSpawnedMarker"]}}
