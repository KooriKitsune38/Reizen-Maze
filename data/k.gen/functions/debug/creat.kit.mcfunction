...
give @s structure_block{display:{Name:'{"text":"Small Structure (1)","italic":false,"color": "magenta"}',Lore:['{"text": "Template for a Size1 structure.","color": "aqua"}']},BlockEntityTag:{mode:"LOAD",name:"k.gen:templ.1",showboundingbox:true,ignoreEntities:false}}
give @s structure_block{display:{Name:'{"text":"Medium Structure (2)","italic":false,"color": "magenta"}',Lore:['{"text": "Template for a Size2 structure.","color": "aqua"}']},BlockEntityTag:{mode:"LOAD",name:"k.gen:templ.2",showboundingbox:true,ignoreEntities:false}}
give @s structure_block{display:{Name:'{"text":"Big Structure (3)","italic":false,"color": "magenta"}',Lore:['{"text": "Template for a Size3 structure.","color": "aqua"}']},BlockEntityTag:{mode:"LOAD",name:"k.gen:templ.3",showboundingbox:true,ignoreEntities:false}}
