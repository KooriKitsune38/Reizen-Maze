...
give @s llama_spawn_egg{Enchantments:[{}],display:{Name:'{"text": "Structure Side","italic":false,"color": "gold"}',Lore:['{"text": "Spawns an output which can generate.","color": "aqua"}','{"text": "Or delete the marker if placed onto another.","color": "aqua"}','{"text":""}','{"text":"Be Careful!","color": "red"}','{"text":"They generate outwardly,","color": "red"}','{"text":"and don\'t create one at the entrance!","color": "red"}']},EntityTag:{id:"marker",Tags:["k.gSpawnedEntity","k.gMarker","k.gEntity"]}}
give @s llama_spawn_egg{Enchantments:[{}],display:{Name:'{"text": "Levitator (Book Shelf)","italic":false,"color": "gold"}',Lore:['{"text": "Spawns a levitating entity.","color": "aqua"}']},EntityTag:{id:"minecraft:marker",Tags:["k.gMarker","k.gPlaceLev","k.gLevBook"]}}
